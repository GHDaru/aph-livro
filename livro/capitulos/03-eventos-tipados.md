...
2. Classifique nas famílias do vocabulário: `thinking_delta`, `artifact_end`, `citation`, `finished`, `tool_result`. Quais desses têm a *semântica* explicada em outro capítulo, e qual? (Dica: a linha "Ação" da tabela remete aos caps. 05–06 — objetivo 2.)
