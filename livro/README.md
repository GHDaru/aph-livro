...
|---|---|---|
| [Padrão APH v0.8](https://github.com/GHDaru/protocolos/blob/main/padrao/padrao-aph.md) | A proposta prescritiva do livro: o que uma aplicação DEVE adotar para conversar integralmente com o harness via chat. Traz os níveis de conformidade (Observador, Operador, Federado), os requisitos com maturidade declarada, a compatibilidade com a indústria e o checklist. | 018 · 021 · 025 · 029 · 031 · 032 · 035 · 036 · 037 · 038 · 039 · 040 |
| [Anexo A: wire format do chat](https://github.com/GHDaru/protocolos/blob/main/padrao/anexo-a-wire-format.md) | O formato exato das mensagens do chat: JSON Schemas validáveis para evento, snapshot, catálogo, confirmação e erro, mais a superfície HTTP de referência, os códigos de erro e o mapeamento para os laboratórios, com exemplos verificados por gate de CI. | 021 · 029 · 035 |
| [Anexo B: o contrato da junta federada](https://github.com/GHDaru/protocolos/blob/main/padrao/anexo-b-federacao.md) | O fio da federação, entre hospedeiro e aplicação de terceiro: canal e envelope `ghd.*`, contrato de admissão, schema do manifesto, grant de embarque e introspecção, capability, modo embarcado, confiança assimétrica e rota canônica. Nasceu porque dois times, lendo o §4.9, implementaram envelopes incompatíveis. | 033 · 034 · 035 |
| [Glossário da norma](https://github.com/GHDaru/protocolos/blob/main/padrao/glossario.md) | Siglas e termos técnicos como a norma os usa, para quem lê a especificação sem o livro ao lado. O glossário [deste livro](glossario.md) é o didático; onde os dois falam do mesmo termo, o da norma manda. | 035 |
| [Suíte de conformidade do Nível 1](https://github.com/GHDaru/protocolos/blob/main/conformidade/README.md) | O examinador executável: testa de fora, em caixa-preta, se uma aplicação cumpre o Nível 1, com 11 checks contra os schemas reais e a lista do que autodeclarar. É autotestada por sabotagens no CI. | 026 · 027 |
