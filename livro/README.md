...
|---|---|---|
| [Padrão APH v0.6](https://github.com/GHDaru/protocolos/blob/main/padrao/padrao-aph.md) | A proposta prescritiva do livro: o que uma aplicação DEVE adotar para conversar integralmente com o harness via chat. Traz os níveis de conformidade (Observador, Operador, Federado), os requisitos com maturidade declarada, a compatibilidade com a indústria e o checklist. | 018 · 021 · 025 · 029 · 031 · 032 · 035 |
