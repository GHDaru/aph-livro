# Tasks 008 — Capítulo 04: A voz da aplicação — contexto de tela

- [x] T001 — Criar `livro/capitulos/04-contexto-de-tela.md` com cabeçalho datado, objetivos de aprendizagem (Bloom) e "O problema" redigido fechando nas quatro tensões (riqueza × privacidade × custo de tokens × sincronia) (CA-1, CA-2)
- [x] T002 — Esqueleto do estado da arte em H3 (decisão fundadora, snapshot, níveis, registro de telas, camada semântica, sanitização, espaço aberto, Leitura executiva), 1–2 frases por seção, respeitando as fronteiras com caps. 07 e 09 (CA-3, CA-5)
