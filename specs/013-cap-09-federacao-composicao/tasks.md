# Tasks 013 — Capítulo 09: Federação e composição (estrutura)

- [x] T001 — Ler insumos obrigatórios (constituição, GUIA-CAPITULO, sumário/fronteiras, os três estudos) e delimitar o que pertence ao cap. 09 (manifesto, handshake, níveis, MCP como projeção) vs. caps. 05/07/10 (CA-5)
- [x] T002 — Redigir cabeçalho datado, objetivos de aprendizagem (verbos de Bloom) e "O problema" completo, ancorado na decisão negativa do `docs/adr/0003-modelos-integracao-aplicacoes.md` (ghdaru), fechando com as restrições em tensão (CA-1, CA-6)
