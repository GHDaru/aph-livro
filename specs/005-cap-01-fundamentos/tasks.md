# Tasks 005 — Capítulo 01: Fundamentos e vocabulário (estrutura)

- [x] T001 — Spec, plan (com Constitution Check) e tasks em `specs/005-cap-01-fundamentos/` (CA-1..CA-6 definidos e testáveis)
- [x] T002 — `livro/capitulos/01-fundamentos.md`: cabeçalho datado, objetivos de aprendizagem (Bloom) e "O problema" redigido em 4–6 parágrafos com evidência por path/URL (CA-1, CA-2, CA-5)
