# Tasks 007 — Capítulo 03: A voz da IA — eventos tipados

- [x] T001 — Verificar por leitura direta os paths de evidência nos dois laboratórios (ghdaru: `models.py`, `events.ts`, `transcript.ts`, spec 007; nexxussai: `stream_event.py`, `provider_stream_normalizer.py`, `contracts/stream-events.md`) (CA-4, CA-6)
- [x] T002 — Criar `livro/capitulos/03-eventos-tipados.md` com cabeçalho datado, objetivos de aprendizagem (verbos de Bloom) e "O problema" redigido por completo, fechando com as restrições em tensão (CA-1, CA-2)
