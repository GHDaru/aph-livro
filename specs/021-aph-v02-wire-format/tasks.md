# Tasks 021 — APH v0.2: Anexo A (wire format)

- [x] T001 — Escrever os 5 schemas (evento, snapshot, acao-catalogo, confirmacao, erro) em draft 2020-12 (CA-1)
- [x] T002 — `exemplos.json` com casos válidos e contraexemplos + `publicar/valida-wire.mjs` (ajv) (CA-2)
